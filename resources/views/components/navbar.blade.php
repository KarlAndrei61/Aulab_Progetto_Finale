        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <form action="{{route('logout')}}" method="POST">
              @csrf
              <button type="submit" class="btn btn-nav textColor ms-2 mt-1  fs-5">{{__('ui.esci')}}</button>
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu categorystyle">
                  <form class="ms-2 mt-2" action="{{route('article.search')}}" method="GET">
                    <div class="m-2">
                      <input type="search" name="query" placeholder="{{__('ui.cerca')}}" class="searchCustom mt-2 searchForm">
                      <button class="bottonecstm" type="submit">{{__('ui.cerca')}}</button>
                    </div>
                  </form>
                </ul>
              </div>
