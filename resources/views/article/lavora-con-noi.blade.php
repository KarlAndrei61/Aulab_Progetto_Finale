            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4  d-flex justify-content-center">
                    <div class="card cardCustomJoinUs">
                        ...
                        <h1 class="textColor mt-3">{{__('ui.joinUs')}}</h1>
                        <h5 class="textColor">{{__('ui.JoinUsSubtitle1')}}</< /h5>
                            <p class="textColor">{{__('ui.JoinUsSubtitle2')}}</p>
                            <form action="{{route('become.revisor')}}">
                                <button class="bottonestyle">{{__('ui.JoinUsSubtitle3')}}</button>
                            </form>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4 d-flex align-items-center">
